...
class Knight
  ...
  def initialize(current_location, children_array, depth = 0)
...
class Board
  ...
  def create_children(new_child_coord)
    knights << Knight.new(new_child_coord, moves_from_current_point(new_child_coord))
  end  
